...
function initMap() {
    ...
    const searchFoodBanks = document.getElementById("searchFB");
    ...
    searchFoodBanks.onclick = function () {
      ...
      geocoder.geocode({ 'address': zipCode }, function (results, status) {
        if (status === 'OK' && results[0].geometry) {
          ...
          service.nearbySearch(
            { location: userLocation, radius: 1000, keyword: ["foodbanks" || "diningroom" || "food_donation"], fields: ["name", "formatted_address", "website", "geometry"] },
