...
function initMap() {
    ...
    const searchHealthcareOptions = document.getElementById("searchH");
    ...
    searchHealthcareOptions.onclick = function () {
      ...
      geocoder.geocode({ 'address': zipCode }, function (results, status) {
        if (status === 'OK' && results[0].geometry) {
          ...
          service.nearbySearch(
            { location: userLocation, radius: 1000, keyword: ["healthcare" || "health_center" || "mental_health" || "health_program"], fields: ["name", "formatted_address", "website", "geometry"] },
